...
import { Instagram, Linkedin, Mail, MapPin, Phone, Send, Twitch, Twitter, Github } from "lucide-react";
    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Ready to build something together? I am always open to chatting about
          ...
          <div className="space-y-8 text-left">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Edmonton, AB, Canada</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a href="mailto:rohanjethwani17@gmail.com">
                  <Mail className="h-6 w-6 text-primary" />
                </a>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-primary"
                  placeholder="rohanjethwani17@gmail.com"
                />
              </div>
